...
pod_info["memory_bytes_limit"] = hostutils.get_file_contents("/sys/fs/cgroup/memory.max")
pod_info["memory_bytes_current"] = hostutils.get_file_contents("/sys/fs/cgroup/memory.current")
